...
if __name__ == "__main__":
    '''
    python apply_net.py show configs/densepose_rcnn_R_101_FPN_DL_s1x.yaml ./pretrained/model_final_844d15.pkl tmp_00006_00.jpg dp_contour,bbox --output image_densepose_contour.png
    '''
    main()
